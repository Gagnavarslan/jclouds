...
public class ProviderModuleExpectTest extends BaseRestApiExpectTest<ProviderModuleExpectTest.DNSApi> {
   ...
   public static class DNSRestClientModule extends RestClientModule<DNSApi, DNSAsyncApi> {
      ...
      public void configure() {
         ...
         }).annotatedWith(DNS.class).to(new TypeLiteral<Supplier<URI>>() {
         });
         super.configure();
      }
   }
   ...
   public void testDNSEndpointApplied() {
      ...
      DNSApi api = requestSendsResponse(
   ...
   private static class DNSApiMetadata extends BaseRestApiMetadata {
      ...
      public static Properties defaultProperties() {
         ...
         properties.setProperty(SERVICE_TYPE, "rax:dns");
      ...
      public static class Builder extends BaseRestApiMetadata.Builder<Builder> {
         ...
         protected Builder() {
            ...
            id("dns")
                  ...
                  .defaultModules(
                        ImmutableSet.<Class<? extends Module>> builder().add(KeystoneAuthenticationModule.class)
                              .add(ProviderModule.class).add(DNSRestClientModule.class).build());
         }
